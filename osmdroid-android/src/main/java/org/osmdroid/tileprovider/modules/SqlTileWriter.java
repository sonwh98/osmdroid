...
public class SqlTileWriter implements IFilesystemCache {
    ...
    public void runCleanupOperation() {
        ...
        try {
            ...
            if (db_file!=null && db_file.length() > OpenStreetMapTileProviderConstants.TILE_MAX_CACHE_SIZE_BYTES) {
                //delete anything that's expired
                ...
                //deletes the oldest tiles in the database.
                ...
                if (tilesToKill > 0)
                    try {
                        ...
                        Log.w(IMapView.LOGTAG, "error purging tiles from the tile cache", t);
                    }
